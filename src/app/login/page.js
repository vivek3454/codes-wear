        ...
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <Link href="/forgot" class="font-semibold text-red-500 hover:text-red-600">Forgot password?</Link>
              </div>
            </div>
            <div class="mt-2">
          ...
          <div>
            <button type="submit" class="flex w-full justify-center rounded-md bg-red-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500">Sign in</button>
          </div>
        </form>

        <p class="mt-10 text-center text-sm text-gray-500">
          Not have an account?
          <Link href="/signup" class="font-semibold ml-1 leading-6 text-red-500 hover:text-red-600">Sign up</Link>
        </p>
      </div>
    </div>
  )
