...
const Hoodies = async () => {
  ...
  return (
    <section className="text-gray-600 container mx-auto">
      ...
      {Object.keys(hoodies).length === 0 && <div className="h-[60vh] flex justify-center items-center text-lg font-semibold">No Tshirts</div>}
        {Object.keys(hoodies).length > 0 && <div className="flex flex-wrap justify-center -m-4">
