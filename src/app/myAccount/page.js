      ...
      <div>
        ...
        <div className="mx-auto flex flex-col md:flex-row my-4">
          <div className="px-2 flex flex-col mt-4 md:mt-0 justify-center w-full md:w-1/2">
            ...
            <input onChange={handleOnchange} value={userInfo.currentPassword} type="text" name='currentPassword' id='currentPassword' className='px-2 h-10 rounded border-2 border-gray-300' />
          </div>
          <div className="px-2 flex flex-col justify-center w-full md:w-1/2">
            <label htmlFor="password" className='text-gray-500'>New Password</label>
            <input onChange={handleOnchange} value={userInfo.newPassword} type="text" name='newPassword' id='newPassword' className='px-2 h-10 rounded border-2 border-gray-300' />
          </div>
          <div className="px-2 flex flex-col mt-4 md:mt-0 justify-center w-full md:w-1/2">
            <label htmlFor="changePassword" className='text-gray-500'>Confirm New Password</label>
            <input onChange={handleOnchange} value={userInfo.confirmPassword} type="text" name='confirmPassword' id='confirmPassword' className='px-2 h-10 rounded border-2 border-gray-300' />
          </div>
        </div>
